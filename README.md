...
```
docker run -p 8108:8108 -v/tmp/data:/data typesense/typesense:0.22.0 --data-dir /data --api-key=Hu52dwsas2AdxdE
```
...
Here's how: [https://typesense.org/docs/0.22.0/guide/#search-ui](https://typesense.org/docs/0.22.0/guide/#search-ui) 
