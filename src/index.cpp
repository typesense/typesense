...
void Index::recursive_filter(uint32_t *&filter_ids, uint32_t &filter_ids_length,
                             ...
                             const bool enable_short_circuit) const
{
    ...
    {
        recursive_filter(l_filter_ids, l_filter_ids_length, root->left, enable_short_circuit);
    }
    ...
    {
        recursive_filter(r_filter_ids, r_filter_ids_length, root->right, enable_short_circuit);
    }
                                  ...
                                  std::array<spp::sparse_hash_map<uint32_t, int64_t> *, 3> &field_values) const
{
    for (size_t i = 0; i < sort_fields_std.size(); i++)
    {
        ...
        else if (sort_fields_std[i].name == sort_field_const::eval)
        {
            ...
            recursive_filter(sort_fields_std[i].eval.ids, sort_fields_std[i].eval.size,
